...
# Path to rom_report.py (change if your repo layout differs)
...
def main():
    # Zephyr sets this automatically when run via Twister
    board = os.environ.get("ZEPHYR_BOARD")
    if not board:
        print("Error: ZEPHYR_BOARD environment variable not set.")
        sys.exit(1)
